            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="<?php echo PUBLIC_PATH ?>images/5.jpg" alt="product" class="img-responsive ">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="<?php echo PUBLIC_PATH ?>images/6.jpg" alt="product" class="img-responsive ">
                          </div>
                    </div>
                </div>
        </div>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="<?php echo PUBLIC_PATH ?>images/b1.jpg" alt="product" class="img-responsive ">
                </div>
